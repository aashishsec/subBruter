...
def checking_vesion():
    ...
    url = f"https://api.github.com/repos/aashishsec/subBruter/releases/latest"
    ...
    try:
         ...
         if response.status_code == 200:
            ...
            if latest == version:
                    ...
                    print(f"[{blue}Version{reset}]: {bold}{white}subBruter current version {version} ({green}{message}{reset})")
                    ...
                    print(f"[{blue}Version{reset}]: {bold}{white}subBruter current version {version} ({red}{message}{reset})")

            
    except KeyboardInterrupt as e:
        
            print(f"[{blue}INFO{random_color}]: subBruter says BYE!")
